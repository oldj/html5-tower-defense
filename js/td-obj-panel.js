...
* Last Update: 2010-11-22 13:30:20
*
*/
...
var panel_obj = {
	...
	render: function () {
		...
		ctx.fillText(TD._t("panel_building_title") + this.map.buildings.length, this.x, this.y + 60);
		ctx.fillText(TD._t("panel_monster_title") + this.map.monsters.length, this.x, this.y + 80);
		...
		ctx.font = "normal 12px 'Courier New'";
		ctx.beginPath();
		ctx.fillText("version: " + TD.version, TD.stage.width - TD.padding, TD.stage.height - TD.padding * 2);
		ctx.closePath();
...
var gameover_obj = {
	...
	render: function () {
		...
		ctx.fillStyle = "#ccc";
		ctx.font = "bold 62px 'Essays 1743'";
		ctx.beginPath();
		ctx.fillText("GAME OVER", this.width / 2, this.height / 2)
		ctx.closePath();
		ctx.fillStyle = "#f00";
		ctx.font = "bold 60px 'Essays 1743'";
		ctx.beginPath();
		ctx.fillText("GAME OVER", this.width / 2, this.height / 2)
		ctx.closePath();
